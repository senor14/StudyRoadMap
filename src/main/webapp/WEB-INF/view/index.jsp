                                            ...
                                            <div id="Study_MindMap" class="tabcontent">
                                                ...
                                                <div class=""  style="display:grid; grid-template-columns: repeat(2, 1fr);word-wrap: break-word; height:620px; overflow:auto;">
                                                    ...
                                                    <a href="/roadmaps/<%=roadData.getRoadId()%>" style="z-index: 10000">
                                                        <div style="margin:5%; display: flex;align-items: flex-end;justify-content: center;  border-radius: 5%;height: 200px;border: 3px solid black; background-size: cover; background-image: url('http://127.0.0.1:9000/getRoadMapImage?roadId=<%=roadData.getRoadId()%>')">
