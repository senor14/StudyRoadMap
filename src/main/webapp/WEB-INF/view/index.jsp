                                            ...
                                            <div id="Study_MindMap" class="tabcontent">
                                                ...
                                                <div class=""  style="display:grid; grid-template-columns: repeat(2, 1fr);word-wrap: break-word; height:620px; overflow:auto;">
                                                    ...
                                                    <% for (StudyRoadData roadData : roadDataInfo) { %>
                                                        <div onclick="location.href='/roadmaps/<%=roadData.getRoadId()%>'" style="margin:5%; display: flex;align-items: flex-end;justify-content: center;  border-radius: 5%;height: 200px;border: 3px solid black; background-size: cover; background-image: url('/getRoadMapImage?roadId=<%=roadData.getRoadId()%>')">
                                                            <div >
                                                    ...
                                                    <div id="yes_career" style="position:absolute;  width:100%; top:35% ">
                                                        <div class="wrapper">
                                                            <a class="cta" id="my_career" href="/career/<%=SS_USER_UUID%>">
                                                                ...
                                                                <span style="width: 20px; margin-left: 30px;">
